...
var Composites = []BlockCase{
	...
	{"transformer_block", map[string]any{"d_model": "D", "heads": "H", "kv_heads": "Hkv",
		"head_dim": "dh", "ffn_hidden": "F", "value_embeddings": true}},
	{"gated_deltanet_block", map[string]any{"d_model": "D", "heads": 16.0, "head_dim": 128.0}},
	{"gated_deltanet_block", map[string]any{"d_model": "D", "heads": 32.0, "head_dim": 128.0,
		"v_head_dim": 64.0, "conv_kernel": 3.0, "bias": true, "conv_bias": true}},
	{"mtp_head", map[string]any{"d_model": "D"}},
	{"mtp_head", map[string]any{"d_model": "D", "by": 2.0, "norm": "layernorm", "bias": true}},
	{"transformer_block", map[string]any{"d_model": "D", "heads": "H", "kv_heads": "Hkv",
